              ...
              <section className="well">
                {!this.state.keyringId || this.state.keysLoading ? (
                  ...
                  <>
                    ...
                    <Route exact path='/keyring/key/:keyIdx' render={props => <Key {...props} keyData={this.state.keys[props.match.params.keyIdx]} defaultKeyFpr={this.state.defaultKeyFpr} onChangeDefaultKey={this.handleChangeDefaultKey} onDeleteKey={this.handleDeleteKey} onKeyringChange={this.loadKeyring} />} />
                    <Route exact path='/keyring/key/:keyIdx/user/:userIdx' render={props => <User {...props} keyData={this.state.keys[props.match.params.keyIdx]} onKeyringChange={this.loadKeyring} />} />
